...
{
    public class SmartGrid : C1FlexGrid
    {
        // Конструктор
        public SmartGrid()
        {
        ...
        //
        public void AddItemToContextMenu(string name, Bitmap image, ClickEventHandler handler)
        {
        ...
        public void ExportToExcel_Click(object sender, ClickEventArgs e)
        {
            ...
            styleNumber.SetBorderStyle(XLLineStyleEnum.Thin);
        ...
        /// </summary>
        private void SmartGrid_OwnerDrawCell(object sender, C1.Win.C1FlexGrid.OwnerDrawCellEventArgs e)
        {
